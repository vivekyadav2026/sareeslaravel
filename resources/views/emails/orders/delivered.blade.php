...
<head>
    ...
    <title>Your Order has been Delivered 👑 - RANISAHAB</title>
</head>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td align="center" style="padding-bottom: 25px;">
                                        ...
                                        <h2 style="color: #8a1224; font-size: 24px; font-weight: normal; text-transform: uppercase; margin: 15px 0 10px; letter-spacing: 1px;">Order Delivered</h2>
                                        <p style="color: #555555; font-size: 14px; line-height: 1.6; margin: 0; max-width: 480px;">
                                            Your royal order #{{ $order->order_number }} has been delivered successfully. We hope you love your new couture ensemble!
                                        </p>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td style="padding: 20px; background-color: #faf8f5; border: 1px solid #eae6df; border-radius: 4px;">
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="font-size: 13px; color: #666666;">
                                            <tr>
                                                <td>Delivery Status: <strong style="color: #28a745;">DELIVERED</strong></td>
                                                <td align="right">Delivered To: <strong style="color: #111111;">{{ $order->customer->first_name }} {{ $order->customer->last_name }}</strong></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td style="padding-top: 30px;">
                                        <h3 style="color: #8a1224; font-size: 14px; text-transform: uppercase; letter-spacing: 1px; margin: 0 0 15px; border-bottom: 1px solid #c5a880; padding-bottom: 5px;">Delivered Items</h3>
                                ...
                                <tr>
                                    <td align="center" style="padding-top: 40px; padding-bottom: 10px;">
                                        <p style="color: #666666; font-size: 14px; line-height: 1.6; margin: 0 0 15px 0;">
                                            We would love to hear your feedback on your couture outfit. Please let us know if everything fits and looks perfect!
                                        </p>
                                        <a href="{{ route('home') }}" style="background-color: #8a1224; color: #ffffff; text-decoration: none; padding: 12px 25px; border-radius: 4px; font-size: 13px; font-weight: bold; letter-spacing: 1px; text-transform: uppercase; display: inline-block; box-shadow: 0 3px 8px rgba(138, 18, 36, 0.2);">CONTINUE SHOPPING</a>
                                    </td>
                                </tr>
