            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin.coupons.update', $coupon->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control font-monospace text-uppercase" id="code" name="code" value="{{ old('code', $coupon->code) }}" required>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control" id="limit" name="limit" value="{{ old('limit', $coupon->limit) }}" placeholder="Leave blank for unlimited">
                        </div>
                    </div>
                    ...
                    <div class="form-check form-switch mb-4">
                        <input class="form-check-input" type="checkbox" role="switch" id="is_active" name="is_active" value="1" {{ $coupon->is_active ? 'checked' : '' }}>
                        <label class="form-check-label fw-semibold" for="is_active">Make Coupon Active</label>
                    </div>
